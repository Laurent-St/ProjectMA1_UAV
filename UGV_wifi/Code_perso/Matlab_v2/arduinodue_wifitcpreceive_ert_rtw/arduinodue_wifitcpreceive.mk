###########################################################################
## Makefile generated for Simulink model 'arduinodue_wifitcpreceive'. 
## 
## Makefile     : arduinodue_wifitcpreceive.mk
## Generated on : Sat Dec 16 19:34:28 2017
## MATLAB Coder version: 3.4 (R2017b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/arduinodue_wifitcpreceive.elf
...
PRODUCT_NAME              = arduinodue_wifitcpreceive
MAKEFILE                  = arduinodue_wifitcpreceive.mk
COMPUTER                  = PCWIN64
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/admin/Desktop/UGV_wifi/Code_perso/Matlab_v2
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = arduinodue_wifitcpreceive_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/arduinodue_wifitcpreceive.elf
...
DEFINES_ = -D_RTT_USE_SERIAL0_ -DMODEL=arduinodue_wifitcpreceive -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT -DMW_TIMERID=9 -DMW_TIMERCOUNT=328125 -DMW_SAM_CLOCKID=TC_CMR_TCCLKS_TIMER_CLOCK4 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_BAUDRATE_SERIAL2_=9600 -D_RTT_BAUDRATE_SERIAL3_=9600 -D_RTT_ANALOG_REF_=0 -D_RTT_WIFI_TCP_=1 -D_RTT_WIFI_TCP_SERVER_PORT_ORDERED=50000 -D_RTT_WIFI_TCP_SERVER_=1 -D_RTT_WIFI_Local_IP1=192 -D_RTT_WIFI_Local_IP2=168 -D_RTT_WIFI_Local_IP3=1 -D_RTT_WIFI_Local_IP4=20 -D_RTT_WIFI_SSID=NUMERICABLE-D921 -D_RTT_WIFI_WPA_PASSWORD=BEDEESNNGK -D_RTT_WIFI_WPA=1 -D_RTT_DISABLE_Wifi_DHCP_=0 -D_RTT_WIFI_ESP8266_=1 -D_RTT_WIFI_ESP8266_PORT=3
...
DEFINES_STANDARD = -DMODEL=arduinodue_wifitcpreceive -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
OBJS = MW_SerialWrite.o MW_WiFiTCP.o MW_digitalio.o arduinodue_wifitcpreceive.o wiring_pulse_asm.S.o dtostrf.o cortex_handlers.o hooks.o iar_calls_sam3.o itoa.o syscalls_sam3.o WInterrupts.o wiring.o wiring_analog.o wiring_digital.o wiring_shift.o abi.o IPAddress.o new.o Print.o Reset.o RingBuffer.o Stream.o UARTClass.o USARTClass.o CDC.o PluggableUSB.o USBCore.o wiring_pulse.o WMath.o WString.o watchdog.o variant.o MW_ArduinoHWInit.o io_wrappers.o arduinoARMScheduler.o arm_cortex_m_multitasking.o ESP8266.o SPI.o WiFi.o WiFiClient.o WiFiServer.o WiFiUdp.o server_drv.o spi_drv.o wifi_drv.o
...
%.o : C:/ProgramData/MATLAB/SupportPackages/R2017b/toolbox/target/supportpackages/arduinobase/src/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : C:/ProgramData/MATLAB/SupportPackages/R2017b/toolbox/target/supportpackages/arduinobase/src/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : C:/ProgramData/MATLAB/SupportPackages/R2017b/toolbox/target/supportpackages/arduinobase/src/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : C:/ProgramData/MATLAB/SupportPackages/R2017b/toolbox/target/supportpackages/arduinobase/src/%.cc
	$(CPP) $(CPPFLAGS) -o $@ $<
...
%.o : C:/ProgramData/MATLAB/SupportPackages/R2017b/toolbox/target/supportpackages/arduinobase/src/%.cxx
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : $(START_DIR)/arduinodue_wifitcpreceive_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : $(START_DIR)/arduinodue_wifitcpreceive_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/arduinodue_wifitcpreceive_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : $(START_DIR)/arduinodue_wifitcpreceive_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o $@ $<
...
%.o : $(START_DIR)/arduinodue_wifitcpreceive_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o $@ $<
