###########################################################################
## Makefile generated for Simulink model 'arduinomega2560_wifiudpsend'. 
## 
## Makefile     : arduinomega2560_wifiudpsend.mk
## Generated on : Sun Dec 10 13:08:40 2017
## MATLAB Coder version: 3.4 (R2017b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/arduinomega2560_wifiudpsend.elf
...
PRODUCT_NAME              = arduinomega2560_wifiudpsend
MAKEFILE                  = arduinomega2560_wifiudpsend.mk
COMPUTER                  = PCWIN64
...
MODELREF_LINK_RSPFILE_NAME = arduinomega2560_wifiudpsend_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/arduinomega2560_wifiudpsend.elf
...
DEFINES_ = -DMODEL=arduinomega2560_wifiudpsend -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT -DMW_TIMERID=9 -DMW_TIMERCOUNT=328125 -DMW_SAM_CLOCKID=TC_CMR_TCCLKS_TIMER_CLOCK4 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_BAUDRATE_SERIAL2_=9600 -D_RTT_BAUDRATE_SERIAL3_=9600 -D_RTT_ANALOG_REF_=0 -D_RTT_WIFI_UDP_LOCAL_PORT_ORDERED="333" -D_RTT_WIFI_UDP_=1 -D_RTT_WIFI_Local_IP1=192 -D_RTT_WIFI_Local_IP2=168 -D_RTT_WIFI_Local_IP3=0 -D_RTT_WIFI_Local_IP4=22 -D_RTT_WIFI_SSID=NUMERICABLE-D921 -D_RTT_WIFI_WPA_PASSWORD=BEDEESNNGK -D_RTT_WIFI_WPA=1 -D_RTT_DISABLE_Wifi_DHCP_=1 -D_RTT_WIFI_ESP8266_=1 -D_RTT_WIFI_ESP8266_PORT=3
...
DEFINES_STANDARD = -DMODEL=arduinomega2560_wifiudpsend -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
%.o : $(START_DIR)/arduinomega2560_wifiudpsend_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : $(START_DIR)/arduinomega2560_wifiudpsend_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/arduinomega2560_wifiudpsend_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : $(START_DIR)/arduinomega2560_wifiudpsend_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o $@ $<
...
%.o : $(START_DIR)/arduinomega2560_wifiudpsend_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o $@ $<
