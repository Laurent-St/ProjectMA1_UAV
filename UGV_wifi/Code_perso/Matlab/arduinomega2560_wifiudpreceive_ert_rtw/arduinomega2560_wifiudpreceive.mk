###########################################################################
## Makefile generated for Simulink model 'arduinomega2560_wifiudpreceive'. 
## 
## Makefile     : arduinomega2560_wifiudpreceive.mk
## Generated on : Sun Dec 10 12:30:58 2017
## MATLAB Coder version: 3.4 (R2017b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/arduinomega2560_wifiudpreceive.elf
...
PRODUCT_NAME              = arduinomega2560_wifiudpreceive
MAKEFILE                  = arduinomega2560_wifiudpreceive.mk
COMPUTER                  = PCWIN64
MATLAB_ROOT               = D:/MATLAB~2
MATLAB_BIN                = D:/MATLAB~2/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/admin/Desktop/UGV_wifi/Code_perso/Matlab
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = arduinomega2560_wifiudpreceive_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/arduinomega2560_wifiudpreceive.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/ProgramData/MATLAB/SupportPackages/R2017b/toolbox/target/supportpackages/arduinobase/include -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/arduinomega2560_wifiudpreceive_ert_rtw -IC:/ProgramData/MATLAB/SupportPackages/R2017b/toolbox/target/supportpackages/arduinotarget/arduinotargetdemos -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(ARDUINO_SAM_ROOT)/hardware/sam/1.6.11/system/libsam -I$(ARDUINO_SAM_ROOT)/hardware/sam/1.6.11/system/CMSIS/CMSIS/Include -I$(ARDUINO_SAM_ROOT)/hardware/sam/1.6.11/system/CMSIS/Device/ATMEL -I$(ARDUINO_SAM_ROOT)/hardware/sam/1.6.11/cores/arduino -I$(ARDUINO_SAM_ROOT)/hardware/sam/1.6.11/cores/arduino/avr -I$(ARDUINO_SAM_ROOT)/hardware/sam/1.6.11/variants/arduino_due_x -IC:/ProgramData/MATLAB/SupportPackages/R2017b/toolbox/target/supportpackages/arduinotarget/include -IC:/ProgramData/MATLAB/SupportPackages/R2017b/toolbox/target/supportpackages/arduinotarget/scheduler/include -IC:/ProgramData/MATLAB/SupportPackages/R2017b/toolbox/target/shared/externalmode_daemon/include -IC:/ProgramData/MATLAB/SupportPackages/R2017b/toolbox/target/supportpackages/arduinobase/libs/ESP8266/include -IC:/ProgramData/MATLAB/SupportPackages/R2017b/3P.instrset/arduinoide.instrset/arduino-1.8.1/libraries/WiFi/src -IC:/ProgramData/MATLAB/SupportPackages/R2017b/3P.instrset/arduinoide.instrset/arduino-1.8.1/libraries/WiFi/src/utility -IC:/ProgramData/MATLAB/SupportPackages/R2017b/3P.instrset/arduinoide.instrset/idepkgs/packages/arduino/hardware/sam/1.6.11/libraries/SPI/src
...
DEFINES_ = -DMODEL=arduinomega2560_wifiudpreceive -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DON_TARGET_WAIT_FOR_START=1 -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DEXT_MODE=1 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT -DMW_TIMERID=9 -DMW_TIMERCOUNT=328125 -DMW_SAM_CLOCKID=TC_CMR_TCCLKS_TIMER_CLOCK4 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_BAUDRATE_SERIAL2_=9600 -D_RTT_BAUDRATE_SERIAL3_=9600 -D_RTT_ANALOG_REF_=0 -D_RTT_WIFI_UDP_LOCAL_PORT_ORDERED="333" -D_RTT_WIFI_UDP_=1 -D_RTT_WIFI_Local_IP1=192 -D_RTT_WIFI_Local_IP2=168 -D_RTT_WIFI_Local_IP3=1 -D_RTT_WIFI_Local_IP4=20 -D_RTT_WIFI_SSID=ugv_wifi -D_RTT_WIFI_WPA_PASSWORD=protect -D_RTT_WIFI_WPA=1 -D_RTT_DISABLE_Wifi_DHCP_=0 -D_RTT_USE_SERIAL0_ -D_RTT_WIFI_ESP8266_=1 -D_RTT_WIFI_ESP8266_PORT=3
...
DEFINES_STANDARD = -DMODEL=arduinomega2560_wifiudpreceive -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
OBJS = MW_WiFiUDP.o arduinomega2560_wifiudpreceive.o updown.o ext_work.o rtiostream_utils.o wiring_pulse_asm.S.o dtostrf.o cortex_handlers.o hooks.o iar_calls_sam3.o itoa.o syscalls_sam3.o WInterrupts.o wiring.o wiring_analog.o wiring_digital.o wiring_shift.o abi.o IPAddress.o new.o Print.o Reset.o RingBuffer.o Stream.o UARTClass.o USARTClass.o CDC.o PluggableUSB.o USBCore.o wiring_pulse.o WMath.o WString.o watchdog.o variant.o MW_ArduinoHWInit.o io_wrappers.o arduinoARMScheduler.o arm_cortex_m_multitasking.o rtiostream_interface.o ext_svr_daemon.o rtiostream_serial_daemon.o daemon_checksum.o ESP8266.o SPI.o WiFi.o WiFiClient.o WiFiServer.o WiFiUdp.o server_drv.o spi_drv.o wifi_drv.o
...
%.o : $(START_DIR)/arduinomega2560_wifiudpreceive_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : $(START_DIR)/arduinomega2560_wifiudpreceive_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/arduinomega2560_wifiudpreceive_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : $(START_DIR)/arduinomega2560_wifiudpreceive_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o $@ $<
...
%.o : $(START_DIR)/arduinomega2560_wifiudpreceive_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o $@ $<
...
MW_WiFiUDP.o : C:/ProgramData/MATLAB/SupportPackages/R2017b/toolbox/target/supportpackages/arduinobase/src/MW_WiFiUDP.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
ESP8266.o : C:/ProgramData/MATLAB/SupportPackages/R2017b/toolbox/target/supportpackages/arduinobase/libs/ESP8266/src/ESP8266.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


SPI.o : C:/ProgramData/MATLAB/SupportPackages/R2017b/3P.instrset/arduinoide.instrset/idepkgs/packages/arduino/hardware/sam/1.6.11/libraries/SPI/src/SPI.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


WiFi.o : C:/ProgramData/MATLAB/SupportPackages/R2017b/3P.instrset/arduinoide.instrset/arduino-1.8.1/libraries/WiFi/src/WiFi.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


WiFiClient.o : C:/ProgramData/MATLAB/SupportPackages/R2017b/3P.instrset/arduinoide.instrset/arduino-1.8.1/libraries/WiFi/src/WiFiClient.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


WiFiServer.o : C:/ProgramData/MATLAB/SupportPackages/R2017b/3P.instrset/arduinoide.instrset/arduino-1.8.1/libraries/WiFi/src/WiFiServer.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


WiFiUdp.o : C:/ProgramData/MATLAB/SupportPackages/R2017b/3P.instrset/arduinoide.instrset/arduino-1.8.1/libraries/WiFi/src/WiFiUdp.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


server_drv.o : C:/ProgramData/MATLAB/SupportPackages/R2017b/3P.instrset/arduinoide.instrset/arduino-1.8.1/libraries/WiFi/src/utility/server_drv.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


spi_drv.o : C:/ProgramData/MATLAB/SupportPackages/R2017b/3P.instrset/arduinoide.instrset/arduino-1.8.1/libraries/WiFi/src/utility/spi_drv.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


wifi_drv.o : C:/ProgramData/MATLAB/SupportPackages/R2017b/3P.instrset/arduinoide.instrset/arduino-1.8.1/libraries/WiFi/src/utility/wifi_drv.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
